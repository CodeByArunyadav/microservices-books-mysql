...
public class OpenApiConfig {
	...
	public OpenAPI customOpenAPI() {
		...
		return new OpenAPI()
				...
				// API Information
				.info(new Info().title("Rating Management API").version("1.0.0")
				...
				.servers(
						List.of(new Server().url("http://localhost:8080/rating-service").description("Local API Gateway"),
								new Server().url("http://172.26.234.58:8080/rating-service").description("Docker API Gateway")))
